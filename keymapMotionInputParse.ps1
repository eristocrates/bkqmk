...
# Convert the collected keycodes to JSON and save to a file
$jsonOutput = $keycodes | ConvertTo-Json -Depth 4
$outputFilePath = "keycodes_and_directions.json"
Set-Content -Path $outputFilePath -Value $jsonOutput

# Write-Output "JSON output saved to $outputFilePath"
