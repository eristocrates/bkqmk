...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    */
    ...
    switch (keycode) {
        ...
        case MD_WHEN:
            if (record->event.pressed) {
                send_string_with_caps_word("when");
            }
            return true;
        case MD_BE:
            if (record->event.pressed) {
                send_string_with_caps_word("be");
            }
            return true;
        case MD_OF:
            if (record->event.pressed) {
                send_string_with_caps_word("of");
            }
            return true;
        case MD_INW:
            if (record->event.pressed) {
        ...
        case MD_THAT:
            if (record->event.pressed) {
                send_string_with_caps_word("that");
            }
            return true;
        case MD_HAVE:
            if (record->event.pressed) {
                send_string_with_caps_word("have");
            }
            return true;
        case MD_IT:
            if (record->event.pressed) {
                send_string_with_caps_word("it");
            }
            return true;
        case MD_NOT:
            if (record->event.pressed) {
                send_string_with_caps_word("not");
            }
            return true;
        case MD_ON:
            if (record->event.pressed) {
                send_string_with_caps_word("on");
            }
            return true;
        case MD_HE:
            if (record->event.pressed) {
                send_string_with_caps_word("he");
            }
            return true;
        case MD_AS:
            if (record->event.pressed) {
                send_string_with_caps_word("as");
            }
            return true;
        case MD_DO:
            if (record->event.pressed) {
                send_string_with_caps_word("do");
            }
            return true;
        case MD_AT:
            if (record->event.pressed) {
                send_string_with_caps_word("at");
            }
            return true;
        case MD_BCUZ:
            if (record->event.pressed) {
                send_string_with_caps_word("because");
            }
            return true;
        case MD_A:
            if (record->event.pressed) {
...
bool process_combo_key_release(uint16_t combo_index, combo_t *combo, uint8_t key_index, uint16_t keycode) {
    ...
    switch (combo_index) {
        case TWO_GRAM_COMBO_LY:
        case WORD_COMBO_THE:
        case WORD_COMBO_ANDL:
        case WORD_COMBO_ANDR:
        case WORD_COMBO_FOR:
        case THREE_GRAM_COMBO_INGL:
        case THREE_GRAM_COMBO_INGR:
        case FOUR_GRAM_COMBO_SION:
        case FOUR_GRAM_COMBO_TION:
        case FOUR_GRAM_COMBO_OULD:
        case WORD_COMBO_TO:
        case WORD_COMBO_FROM:
        case WORD_COMBO_BUT:
        case WORD_COMBO_I:
        case WORD_COMBO_IPD:
        case WORD_COMBO_IPLL:
        case WORD_COMBO_IPM:
        case WORD_COMBO_IPVE:
        case WORD_COMBO_YOU:
        case WORD_COMBO_YOUPD:
        case WORD_COMBO_YOUPLL:
        case WORD_COMBO_YOUPRE:
        case WORD_COMBO_YOUPVE:
        case WORD_COMBO_YOUR:
        case WORD_COMBO_THEIR:
        case WORD_COMBO_THEYPRE:
        case WORD_COMBO_THERE:
        case WORD_COMBO_THEY:
        case WORD_COMBO_THEYPD:
        case WORD_COMBO_THEYPLL:
        case WORD_COMBO_HERE:
        case WORD_COMBO_WHERE:
        case WORD_COMBO_WEPRE:
        case WORD_COMBO_WERE:
        case WORD_COMBO_WEPD:
        case WORD_COMBO_WELL:
        case WORD_COMBO_WEPLL:
        case WORD_COMBO_WEPVE:
        case WORD_COMBO_WHAT:
        ...
        case WORD_COMBO_BE:
        case WORD_COMBO_INW:
        case WORD_COMBO_THAT:
        case WORD_COMBO_HAVE:
        case WORD_COMBO_IT:
        case WORD_COMBO_NOT:
        case WORD_COMBO_ON:
        case WORD_COMBO_HE:
        ...
        case WORD_COMBO_DO:
        case WORD_COMBO_AT:
        case WORD_COMBO_BECAUSE:
        case WORD_COMBO_A:
        case THREE_GRAM_COMBO_GHT:
            if (smart_space_mode) {
                tap_code(KC_SPC);
                last_smart_space = true;
            }
