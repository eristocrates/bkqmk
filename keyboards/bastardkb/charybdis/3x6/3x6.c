...
led_config_t g_led_config = { {
    ...
    /* index=15 */ LED_FLAG_INDLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_INDLIGHT,
    // /* index=15 */ LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT,
    /* index=18 */ LED_FLAG_MODLIGHT, LED_FLAG_MODLIGHT, LED_FLAG_MODLIGHT, // Thumb cluster
    ...
    /* index=36 */ LED_FLAG_INDLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_INDLIGHT,
    // /* index=36 */ LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT, LED_FLAG_KEYLIGHT,
    /* index=39 */ LED_FLAG_MODLIGHT, LED_FLAG_MODLIGHT, LED_FLAG_MODLIGHT, // Thumb cluster
